...
1.  **Text Content (CRITICAL):** The text displayed on the thumbnail image MUST be derived *ONLY* from the absolute most essential, concise phrase or keywords from the video topic: ({{{videoTopic}}}). It should be extremely short and impactful. Absolutely NO additional words, sentences, or elaborations beyond this core topic phrase are permitted.
...
IMPORTANT - TEXT CONTENT (CRITICAL):
The text displayed on the thumbnail image MUST be derived *ONLY* from the absolute most essential, concise phrase or keywords from the video topic: "${input.videoTopic}". It should be extremely short and impactful. Absolutely NO additional words, sentences, or elaborations beyond this core topic phrase are permitted.
